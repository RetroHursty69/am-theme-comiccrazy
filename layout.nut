...
//adjust the values below for the static preview video snap
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.657, fly*0.266, flw*0.35, flh*0.43 );
...
surface_snap.set_pos(flx*0.657, fly*0.266, flw*0.35, flh*0.43 );
surface_snap.skew_y = 0;
surface_snap.skew_x = 0;
surface_snap.pinch_y = -80;
surface_snap.pinch_x = 0;
surface_snap.rotation = 1;
...
{
local boxart = fe.add_artwork("boxart", flx*0.85, fly*0.78, flw*0.115, flh*0.18 );
}
...
{
//Year text info
local texty = fe.add_text("[Year]", flx*0.21, fly*0.949, flw*0.13, flh*0.035 );
texty.set_rgb( 255, 255, 255 );
//texty.style = Style.Bold;
//texty.align = Align.Left;


local textemu = fe.add_text("[Emulator]", flx* 0.52, fly*0.957, flw*0.6, flh*0.018 );
textemu.set_rgb( 255, 255, 255 );


//Title text info
local textt = fe.add_text( "[Title]", flx*0.405, fly*0.957, flw*0.6, flh*0.018  );
...
//display filter info
local filter = fe.add_text( "[ListFilterName]: [ListEntry]-[ListSize]  [PlayedCount]", flx*0.7, fly*0.957, flw*0.3, flh*0.02 );
...
local glogo1 = fe.add_image("glogos/unknown1.png", flx*0.34, fly*0.945, flw*0.045, flh*0.05);
